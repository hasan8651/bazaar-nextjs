...
export default function PopularCategories() {
  return (
    <section className="py-16 md:py-20 lg:py-24 bg-[var(--background)]">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-5 sm:gap-6 lg:gap-8">
          {categories.map((cat) => (
            <Link
              ...
              className="group relative block overflow-hidden rounded-xl bg-[var(--surface)] border border-[var(--border)] transition-all duration-300 hover:border-[var(--secondary)]/30 hover:shadow-lg hover:-translate-y-1"
            >
              ...
              <div className="relative aspect-[4/3] overflow-hidden">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/25 via-transparent to-transparent opacity-60 group-hover:opacity-80 transition-opacity duration-300" />
              </div>
              ...
              <div className="absolute bottom-0 left-0 right-0 p-5 md:p-6 bg-gradient-to-t from-black/60 to-transparent">
                <h3 className="text-xl md:text-2xl font-bold text-white drop-shadow-md group-hover:text-[var(--secondary)] drop-shadow-[0_2px_6px_rgba(0,0,0,0.85)] transition-colors">
                  {cat.name}
                </h3>
              ...
              <div className="absolute top-4 right-4 opacity-0 group-hover:opacity-100 transition-opacity duration-300 lg:opacity-0">
                <div className="flex items-center justify-center w-10 h-10 rounded-full bg-white/90 backdrop-blur-sm text-[var(--secondary)] shadow-md">
                  <ArrowRight size={20} />
                </div>
              </div>
            </Link>
